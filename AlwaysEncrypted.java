...
public class AlwaysEncrypted {
    ...
    private static final String KEY_ALIAS = "cmk1";

    // Name by which the column master key will be known in the database.
    private static final String COLUMN_MASTER_KEY_NAME = "CMK1";

    // Name by which the column encryption key will be known in the database.
    private static final String COLUMN_ENCRYPTION_KEY = "CEK1";

    // The location of the keystore.
    private static final String KEY_STORE_LOCATION = "./cmk-keystore.jks";

    // The password of the keystore and the key.
    private static final char[] KEY_STORE_SECRET = "YourStrongPassword".toCharArray();
    ...
    public static void main(String[] args) {
        String connectionUrl = String.format("jdbc:sqlserver://%s:%s;user=%s;password=%s;columnEncryptionSetting=Enabled;trustServerCertificate=true;",
